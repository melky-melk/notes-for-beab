...
// an abstract class is like a parent class but empty or the default and parts that HAVE TO be implemented in the subclasses
...
public abstract class Animal {
	...
	// polymorphism means that there are many different versions of the method, but it prioritises the overloaded ones in the subclasses 
}